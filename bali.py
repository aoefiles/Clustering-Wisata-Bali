...
<div class="main-header">
    <h1>Dashboard Klasterisasi Tempat Wisata Bali</h1>
    <p>Eksplorasi Bali Lebih Cerdas dengan Klasterisasi Destinasi Wisata</p>
</div>
""", unsafe_allow_html=True)
...
with st.sidebar:
    ...
    st.info(f"**Wilayah**: {df['kabupaten_kota'].nunique()} kabupaten/kota")
...
with col1:
    ...
    <div class="metric-card">
        ...
        <div class="metric-label">Tempat Wisata</div>
    </div>
    """, unsafe_allow_html=True)
...
if len(filtered_df) > 0:
    ...
    display_df.columns = ["Nama Tempat", "Kategori", "Lokasi", "Rating", "Preferensi"]
...
st.markdown('<h2 class="section-header">Peta Interactive Lokasi Wisata</h2>', unsafe_allow_html=True)
...
if len(filtered_df) > 0:
    ...
    <div style='position: fixed; 
                ...
                background-color: white; color: black; border:2px solid grey; z-index:9999; 
...
# #     <h4 style='color: white; margin-bottom: 1rem;'>Explore Beautiful Bali</h4>
